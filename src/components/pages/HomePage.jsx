        ...
        <form onSubmit={handleSubmit}>
          <label className='input shadow-md flex items-center gap-2'>
            ...
            <input type='text'
              ...
              placeholder='What Do You Want To Cook Today?'></input>
          </label>
        </form>
        <p className='font-bold text-2xl md:text-4xl mt-4'>Top Reccomeded Recipes </p>
        <p className='text-slate-950 font-semibold text-2xl ml-1 my-2 tracking-tight'>Populer Choices</p>
